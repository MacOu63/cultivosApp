        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #f8f9fa; padding: 10px; border-bottom: 1px solid #ddd;">
                    <div>
                        <button class="btn btn-primary btn-sm" title="Crear Nuevo" data-placement="left" onclick="window.location.href='{{ route('departamentos.create') }}'">
                    ...
                    <div class="d-flex align-items-center" style="flex-grow: 1; justify-content: flex-end;">
                        <div class="input-group mr-3" style="max-width: 400px;">
                            ...
                            <form action="{{ route('departamentos.index') }}" method="GET">
                                <div class="row">
                                    <div class="col-8">
                                        <input type="text" name="search" class="form-control" placeholder="Ingresar nombre de departamento:" value="{{ request('search') }}" id="search-input";>
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-outline-secondary rounded-right w-100" type="submit" style="background-color: #007bff; border-color: #007bff; color: white; margin-right:-162px !important; width: 203px !important">
                        ...
                        <!-- Mostrar mensaje de advertencia si no se encuentra el departamento -->
                    ...
                    <form action="{{ route('departamentos.index') }}" method="GET" id="results-form">
                        <div class="form-container">
                            ...
                            <select name="results_per_page" class="form-control form-control-sm results-select" onchange="document.getElementById('results-form').submit();">
                                <option value="7" {{ request('results_per_page') == 7 ? 'selected' : '' }}>7</option>
                                <option value="15" {{ request('results_per_page') == 15 ? 'selected' : '' }}>15</option>
                            </select>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th style="width: 13%;">Departamentos</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="d-flex justify-content-start actions-btns">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="{{ route('departamentos.show', $departamento->id) }}" class="btn btn-sm" style="background-color: #4CAF50; color: white;">
...
<style>
    ...
    @media (min-width: 577px) and (max-width: 768px) {
        ...
        .alert-warning {
            width: 227px; /* Permitir que el ancho sea completo en pantallas pequeñas */
