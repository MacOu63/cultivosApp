        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #f8f9fa; padding: 10px; border-bottom: 1px solid #ddd;">
                    <div>
                        <button class="btn btn-primary btn-sm" title="Crear Nuevo" data-placement="left" onclick="window.location.href='{{ route('precios.create') }}'">
                    ...
                    <form action="{{ route('precios.index') }}" method="GET" id="results-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="d-flex justify-content-start actions-btns">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="{{ route('precios.show', $precio->id) }}" class="btn btn-sm" style="background-color: #4CAF50; color: white;">
                                    ...
                                    <td>{{ $precio->id }}</td>
                                    <td>{{ $precio->precio }}</td>
                                    <td>{{ $precio->cultivo->nombre }}</td>
                                    <td>{{ $precio->departamento->nombre }}</td>
                                    <td>{{ $precio->updated_at->format('d F Y h:i a') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
