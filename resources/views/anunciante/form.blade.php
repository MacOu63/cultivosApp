<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="titulo" class="form-control @error('titulo') is-invalid @enderror" value="{{ old('titulo', $anunciante?->titulo) }}" id="titulo" placeholder="Ingrese el título del anunciante:">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="subtitulo" class="form-control @error('subtitulo') is-invalid @enderror" value="{{ old('subtitulo', $anunciante?->subtitulo) }}" id="subtitulo" placeholder="Ingrese el subtítulo del anunciante:">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <textarea name="contenido" class="form-control @error('contenido') is-invalid @enderror" id="contenido" placeholder="Ingrese el contenido del anunciante:" style="height: 169px;">{{ old('contenido', $anunciante?->contenido) }}</textarea>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <textarea name="link" class="form-control @error('link') is-invalid @enderror" id="link" placeholder="Ingrese el link del anunciante:">{{ old('link', $anunciante?->link) }}</textarea>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <select name="addedBy" class="form-control @error('addedBy') is-invalid @enderror" id="addedBy">
                @foreach($usuarios as $id => $nombre_usuario)
                    <option value="{{ $id }}" {{ old('addedBy', $anunciante->addedBy) == $id ? 'selected' : '' }}>{{ $nombre_usuario }}</option>
                @endforeach
            </select>
