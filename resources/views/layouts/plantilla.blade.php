...
<head>
    ...
    <style>
        ...
        .contact-section {
            /*background-color: #000; /* Puedes cambiar el color de fondo */
            padding: 30px 0px;
        }
        ...
        @media (max-width: 768px) {
            .contact-section .row {
                flex-direction: column-reverse; /* Invierte el orden en pantallas pequeñas */
            }
            .speech-bubble {
                width: 100%;
                margin-bottom: 40px;
        ...
        /* Estilo del globo de texto pixelado con bordes redondeados y la cola en el lado izquierdo */
        .speech-bubble {
            position: relative;
            background: white;
            border: 4px solid black; /* Borde grueso para un efecto más pixelado */
            padding: 10px;
            border-radius: 10px; /* Bordes redondeados */
            display: inline-block;
            max-width: 555px;
            font-family: 'Courier New', Courier, monospace; /* Fuente con aspecto pixelado */
            font-size: 17px;
            line-height: 1.2;
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4"><a class="nav-link text-uppercase active" href="contactanos">Contactanos</a></li>
                </ul>
            </div>
        </div>
    </nav>

    <section class="page-section cta" style="background-color: rgba(238,208,182,0.7);">
        <div class="container">
            <div class="row">
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="assets/img/agricultor.png" alt="Personaje" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <div class="speech-bubble">
                        <p>Si tienes alguna duda, no dudes en escribirnos; estamos más que dispuestos a ayudarte.</p>
                        <p>Si no tienes correo electrónico, puedes comunicarte con nosotros por WhatsApp a los siguientes números:
                            <a href="https://wa.me/+51957874833">957-874-833</a> o <a href="https://wa.me/+51993396039 ">993-396-039</a>.
                        </p>
                    </div>
                </div>
            </div>
