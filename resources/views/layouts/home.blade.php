...
<html lang="en">
    ...
    <body style="background-color: #feece5;">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase active" href="inicio">Inicio</a></li>
        ...
        <section class="page-section cta">
            <div class="card mb-3 mx-auto" style="max-width: 80%;">
                <img src="assets/img/noticiasbanner.jpg" class="card-img-top img-fluid" alt="Noticias" />
                <div class="card-body">
